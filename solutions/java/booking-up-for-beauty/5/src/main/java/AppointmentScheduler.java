...
class AppointmentScheduler {
    ...
    public String getDescription(LocalDateTime appointmentDate) {
        ...
        String time = String.valueOf(appointmentDate.format(DateTimeFormatter.ofPattern("EEEE, MMMM d, YYYY 'at' h:mm a",Locale.ENGLISH)));
        //return "You have an appointment on "+day+", "+month+" "+monthDay+", "+year+", at "+time+".";
        return "You have an appoinment on "+time;
    }
